  ...
  <div>
    ...
    <div v-else-if='loaded'>
      ...
      <div class="alert alert-secondary">
        ...
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" value="stop_kafka" v-model='actionName'>
          <label class="form-check-label">Stop Kafka</label>
        </div>
        <div class="form-check form-check-inline">
     ...
     <!-- Stop Kafka option -->
      <div class="alert alert-danger" v-if='actionName === "stop_kafka"'>
        <h5>Stop Kafka Service</h5>
        <hr>
        <div class="row">
          <div class="col-md-4">
            <div class="form-check form-check-inline">
     ...
     <!-- Start Kafka option -->
      <div class="alert alert-info" v-if='actionName === "start_kafka"'>
        <h5>Start Kafka Service</h5>
        <hr>
        <div class="row">
          <div class="col-md-4">
            <div class="form-check form-check-inline">
